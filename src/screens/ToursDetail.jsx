    ...
    <>
      ...
      <div className="tour_detail_container">
        <div className="tour_detail_content">
          <p>
            Please note that this is just a sample itinerary, and … we can
            customize it according to your preferences and requirements. The Omo
            Valley is a culturally rich and diverse region, and this photography
            tour will provide you with ample opportunities to capture stunning
            images of the tribes, landscapes, and wildlife that make this region
            so unique.
          </p>
